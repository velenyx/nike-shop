...
const Home = () => {
  return (
    ...
    >
      ...
      <div className="before:bg-gradient-radial before:from-white before:to-transparent after:bg-gradient-conic after:from-sky-200 after:via-blue-200 before:dark:from-transparent before:dark:to-blue-700/10 after:dark:from-sky-900 relative flex place-items-center before:absolute before:h-[300px] before:w-[480px] before:-translate-x-1/2 before:rounded-full before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] after:w-[240px] after:translate-x-1/3 after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br after:dark:via-[#0141ff]/40 before:lg:h-[360px]">
        <Image
          priority
          alt='Next.js Logo'
